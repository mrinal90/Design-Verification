...
# DVE reload session
# Saved on Tue Mar 20 15:45:15 2018
# Designs open: 1
...
set _session_group_2 xif
gui_sg_create "$_session_group_2"
set xif "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { {tb.xif.$unit} tb.xif.clk_156m25 tb.xif.reset_156m25_n tb.xif.reset_xgmii_rx_n tb.xif.reset_xgmii_tx_n tb.xif.pkt_rx_ren tb.xif.pkt_tx_data tb.xif.pkt_tx_eop tb.xif.pkt_tx_mod tb.xif.pkt_tx_sop tb.xif.pkt_tx_val tb.xif.wb_adr_i tb.xif.wb_clk_i tb.xif.wb_cyc_i tb.xif.wb_dat_i tb.xif.wb_rst_i tb.xif.wb_stb_i tb.xif.wb_we_i tb.xif.xgmii_rxc tb.xif.xgmii_rxd tb.xif.pkt_rx_avail tb.xif.pkt_rx_data tb.xif.pkt_rx_eop tb.xif.pkt_rx_err tb.xif.pkt_rx_mod tb.xif.pkt_rx_sop tb.xif.pkt_rx_val tb.xif.pkt_tx_full tb.xif.wb_ack_o tb.xif.wb_dat_o tb.xif.wb_int_o tb.xif.xgmii_txc tb.xif.xgmii_txd tb.xif.clk_xgmii_rx tb.xif.clk_xgmii_tx }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 54529
...
gui_list_set_insertion_bar  -id ${Wave.1} -group xif  -position in
